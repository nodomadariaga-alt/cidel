...
export default function FloatingSocials({ whatsappNumber }: Props) {
    ...
    return (
        <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-3 p-2 bg-white/90 backdrop-blur-md border border-r-0 border-gray-200 rounded-l-2xl shadow-lg">
